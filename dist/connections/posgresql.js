...
var postgresqltransaction = (function () {
    ...
    postgresqltransaction.prototype.begin = function () {
        if (this._begin)
            throw 'The function "begin" was already called. Create a new transaction';
        this._begin = true;
        var st = this;
    ...
    postgresqltransaction.prototype.commit = function () {
        if (!this._begin)
            throw "Transaction has not begun. Make sure to call begin()";
        if (this._finished)
            throw "The Transaction has already ended create a new transaction.";
        this._finished = true;
        var st = this;
        return new Promise(function (resolve, reject) {
    ...
    postgresqltransaction.prototype.query = function (queryString, values) {
        if (!this._begin || this._finished)
            throw "The transaction is not active.";
        var sc = this._connection;
        var st = this;
        return new Promise(function (resolve, reject) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    st._transaction.query(queryString, values).then(function (result) {
...
var postgresqlconnection = (function () {
    ...
    postgresqlconnection.prototype.query = function (queryString, values) {
        ...
        return new Promise(function (resolve, reject) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    sc._dbObject.connect(function (err, client, done) {
                        if (err) {
                            done(err);
                            return reject(new Error(err));
                        }
                        client.query(queryString, values, function (error, results) {
                            if (error) {
                                done(error);
...
//# sourceMappingURL=posgresql.js.map